	...
	<div className="min-h-screen bg-gradient-to-b from-[#0a0e27] to-[#1a1f3a] py-12 px-4">
	  <div className="max-w-4xl mx-auto">
		...
		<div className="mb-12 text-center">
		  <h1 className="text-5xl font-bold mb-4 text-blue-hero">Labyrinth Rules</h1>
		...
		<div className="space-y-8">
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			...
			<p className="text-light-cyan leading-relaxed mb-3">
			...
			<div className="space-y-3 text-light-cyan">
			  <ul className="space-y-2 ml-4">
				<li className="flex gap-3">
				  ...
				  <span>You can only move to adjacent tiles if their openings are aligned (connected)</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>You cannot move through walls. If tiles are not connected, the path is blocked</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>You move one tile per action during your turn</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>Multiple players can occupy the same tile</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>You move within the board boundaries. When a row/column shifts, you wrap around to the opposite side</span>
				</li>
			  </ul>
			</div>
		  </section>
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			...
			<p className="text-light-cyan mb-4">Each turn, before or during movement, you can manipulate the board to create new paths:</p>
			<div className="space-y-3 text-light-cyan">
			  <div className="bg-bg-dark p-4 rounded border border-cyan-dark">
				<p className="font-bold text-cyan-bright mb-2">Rotate a Tile</p>
				<p className="text-sm">Select a tile and rotate it 90° clockwise. Creates or closes paths to adjacent tiles. Cannot rotate tiles with players on them.</p>
			  </div>
			  <div className="bg-bg-dark p-4 rounded border border-cyan-dark">
				<p className="font-bold text-cyan-bright mb-2">Swap Tiles</p>
				<p className="text-sm">Exchange the positions of two tiles on the board. Cannot swap tiles with players on them. Useful for reorganizing the labyrinth.</p>
			  </div>
			  <div className="bg-bg-dark p-4 rounded border border-cyan-dark">
				<p className="font-bold text-cyan-bright mb-2">Shift Row/Column</p>
				<p className="text-sm">Move an entire row or column left, right, up, or down. Tiles wrap around to the opposite side. Players on that row/column also shift with it.</p>
			  </div>
			</div>
		  </section>
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			...
			<div className="space-y-3 text-light-cyan">
			  <ul className="space-y-2 ml-4">
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">•</span>
				  <span>Certain tiles contain collectible items</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">•</span>
				  <span>When you move to a tile with a collectible, you automatically collect it</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">•</span>
				  <span>Collected items contribute to your objectives</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">•</span>
				  <span>In multiplayer, each player collects independently</span>
				</li>
			  </ul>
			</div>
		  </section>
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			...
			<div className="space-y-3 text-light-cyan">
			  ...
			  <ul className="space-y-2 ml-4">
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>Collecting all required collectibles</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>Reaching the exit point (if one exists)</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✓</span>
				  <span>Completing all assigned objectives before other players (multiplayer)</span>
				</li>
			  </ul>
      </div>
		  </section>
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			...
			<div className="space-y-3 text-light-cyan">
			  <ul className="space-y-2 ml-4">
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✗</span>
				  <span><strong>Exceed Maximum Moves:</strong> Some levels have a move limit. Exceeding it ends the game as a loss.</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✗</span>
				  <span><strong>Time Limit:</strong> If the level has a time constraint, running out of time ends the game as a loss.</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">✗</span>
				  <span><strong>Other Players Finish First:</strong> In multiplayer, if another player completes their objectives first, you lose.</span>
				</li>
			  </ul>
			</div>
		  </section>
		  ...
		  <section className="bg-bg-dark-secondary border border-[var(--color-border-subtle)] rounded-lg p-6">
			<h2 className="text-2xl font-bold text-cyan-bright mb-4">💡 Strategy Tips</h2>
			<div className="space-y-3 text-light-cyan">
			  <ul className="space-y-2 ml-4">
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>Plan your moves ahead before manipulating tiles</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>Rotate tiles to create paths toward collectibles and exits</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>Use shifts strategically to move yourself closer to your goals</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>In multiplayer, anticipate opponent movements and block their paths if needed</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>Watch your move count and time limit carefully</span>
				</li>
				<li className="flex gap-3">
				  <span className="text-cyan-bright font-bold">→</span>
				  <span>Communicate with teammates if playing cooperatively</span>
				</li>
			  </ul>
			</div>
		  </section>
