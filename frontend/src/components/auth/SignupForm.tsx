      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 border border-cyan-500/30 rounded-3xl p-10 w-full max-w-md shadow-2xl shadow-cyan-500/20 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-750 text-white font-medium py-3 rounded-xl border border-gray-700 transition-all"
          >
          ...
          <button
            ...
            className="mt-3 w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-750 text-white font-medium py-3 rounded-xl border border-gray-700 transition-all"
          >
