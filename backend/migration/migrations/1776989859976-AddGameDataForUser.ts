...
export class AddGameDataForUser1774989859976 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_users_avatar_image"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_adae49d181d913e047f59e07223" FOREIGN KEY ("avatar_image_id") REFERENCES "images"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_adae49d181d913e047f59e07223"`);
